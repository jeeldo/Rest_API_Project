...
public class CadastroUsuarioService {
	...
	private static final String MSG_USUARIO_EM_USO = "Não é possível excluir o usuário de código %d pois está em uso";
	@Autowired
	...
	public void alterarSenha(Long usuarioId, String senhaAtual, String novaSenha) {
		...
		if(passwordEncoder.matches(senhaAtual, usuario.getSenha())) {
			...
			throw new NegocioException("A senha atual informada não coincide com a senha atual correta");
		}
	}
