...
import com.algaworks.algafood.api.v1.assembler.disassembler.FormaPagamentoInputDisassembler;
...
public class FormaPagamentoController implements FormaPagamentoControllerOpenApi{
	...
	public ResponseEntity<CollectionModel<FormaPagamentoModel>> listar (ServletWebRequest request) {
		...
		CollectionModel<FormaPagamentoModel> formasPagamentoModel = formaPagamentoModelAssembler.toCollectionModel(todasFormasPagamento);
...
//				.cacheControl(CacheControl.noStore())
	...
	public ResponseEntity<FormaPagamentoModel> buscar (@PathVariable Long formaPagamentoId, ServletWebRequest request) {
		...
		OffsetDateTime dataAtualizacao = formaPagamentoRepository.findById(formaPagamentoId).get().getDataAtualizacao();
//		OffsetDateTime dataAtualizacao = cadastroFormaPagamento.buscarOuFalhar(formaPagamentoId).getDataAtualizacao();
