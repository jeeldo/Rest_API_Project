...
insert into permissao (id, nome, descricao) values (5, 'EDITAR_USUARIOS', 'Permite criar ou editar usuários');
insert into permissao (id, nome, descricao) values (6, 'EDITAR_RESTAURANTES', 'Permite criar, editar ou gerenciar restaurantes');
