...
insert into permissao (id, nome, descricao) values (5, 'EDITAR_USUARIOS_GRUPOS_PERMISSOES', 'Permite criar ou editar usuários grupos e permissoes');
insert into permissao (id, nome, descricao) values (6, 'CONSULTAR_USUARIOS_GRUPOS_PERMISSOES', 'Permite consultar usuários grupos e permissoes');
insert into permissao (id, nome, descricao) values (7, 'CONSULTAR_PEDIDOS', 'Permite consultar pedidos');
insert into permissao (id, nome, descricao) values (8, 'GERENCIAR_PEDIDOS', 'Permite gerenciar pedidos');
insert into permissao (id, nome, descricao) values (9, 'GERAR_RELATORIOS', 'Permite gerar relatórios');
insert into permissao (id, nome, descricao) values (10, 'EDITAR_RESTAURANTES', 'Permite criar, editar ou gerenciar restaurantes');
...
(1, 'João da Silva', 'joao.ger@algafood.com.br', '$2a$12$nMmTGyt1zdq3PoA3FfEaLek2qO9/GmXpBo5ZO1Yq8F8JrG.fgL.PW', utc_timestamp),
(2, 'Maria Joaquina', 'maria.vnd@algafood.com.br', '$2a$12$nMmTGyt1zdq3PoA3FfEaLek2qO9/GmXpBo5ZO1Yq8F8JrG.fgL.PW', utc_timestamp),
(3, 'José Souza', 'jose.aux@algafood.com.br', '$2a$12$nMmTGyt1zdq3PoA3FfEaLek2qO9/GmXpBo5ZO1Yq8F8JrG.fgL.PW', utc_timestamp),
(4, 'Sebastião Martins', 'sebastiao.cad@algafood.com.br', '$2a$12$nMmTGyt1zdq3PoA3FfEaLek2qO9/GmXpBo5ZO1Yq8F8JrG.fgL.PW', utc_timestamp),
(5, 'Manoel Lima', 'manoel.loja@gmail.com', '$2a$12$nMmTGyt1zdq3PoA3FfEaLek2qO9/GmXpBo5ZO1Yq8F8JrG.fgL.PW', utc_timestamp),
(6, 'Débora Mendonça', 'jeanrmsevero+teste@gmail.com', '$2a$12$nMmTGyt1zdq3PoA3FfEaLek2qO9/GmXpBo5ZO1Yq8F8JrG.fgL.PW', utc_timestamp),
(7, 'Jean Mello', 'jeanrmsevero@gmail.com', '$2a$12$nMmTGyt1zdq3PoA3FfEaLek2qO9/GmXpBo5ZO1Yq8F8JrG.fgL.PW', utc_timestamp);
...
values (
  'foodanalytics', null, '$2a$12$YKOek3Ruvuc7RrSeGLrwDudbNQgmicL3XYH4jyGokav91gw.vymom',
